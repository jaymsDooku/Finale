...
public class FinaleManager {
	...
	public FinaleManager(boolean debug, boolean attackSpeedEnabled, double attackSpeed, Map<EntityDamageEvent.DamageCause, Integer> invulnerableTicks, boolean regenHandlerEnabled,
			SaturationHealthRegenHandler regenHandler, WeaponModifier weaponModifier, ArmourModifier armourModifier, PotionHandler potionHandler, CombatConfig combatConfig, ArcherConfig archerConfig, EngineerConfig engineerConfig) {
		...
		this.archerConfig = archerConfig;
	...
	public EngineerConfig getEngineerConfig() {
