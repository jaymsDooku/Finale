...
public class CombatConfigCommand extends StandaloneCommand {
	...
	public boolean execute(CommandSender arg0, String[] arg1) {
		...
		if (arg1.length == 0) {
			...
			arg0.sendMessage(ChatColor.WHITE + "waterHorizontal: " + ChatColor.RED + cc.getWaterHorizontal());
			arg0.sendMessage(ChatColor.WHITE + "waterVertical: " + ChatColor.RED + cc.getWaterVertical());
		...
		switch(propName) {
			...
			case "waterHorizontal":
				cc.setWaterHorizontal(num);
				break;
			case "waterVertical":
				cc.setWaterVertical(num);
				break;
			case "attackMotion":
